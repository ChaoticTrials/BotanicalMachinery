...
public class ScreenManaBlock extends ContainerScreen<ContainerManaBlock> {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.font.drawString("Current mana: " + ((TileManaBlock) this.getContainer().tile).getCurrentMana(), 8, 8, 0xffffff);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (!TileManaBlock.enoughMana) {
            ...
            this.minecraft.getTextureManager().bindTexture(new ResourceLocation(BotanicalMachinery.MODID, "textures/gui/misc/hud.png"));

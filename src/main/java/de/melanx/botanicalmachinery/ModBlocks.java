...
public class ModBlocks {
    ...
    public static final MenuBlockBE<BlockEntityMechanicalManaInfuser, ContainerMenuMechanicalManaInfuser> mechanicalManaInfuser = new BlockMechanicalManaInfuser(BotanicalMachinery.getInstance(), BlockEntityMechanicalManaInfuser.class, BlockEntityMenu.createMenuType(ContainerMenuMechanicalManaInfuser::new));

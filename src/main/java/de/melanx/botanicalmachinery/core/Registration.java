...
public class Registration {
    ...
    public static final RegistryObject<TileEntityType<?>> TILE_MECHANICAL_BREWERY = TILES.register(LibNames.MECHANICAL_BREWERY, () -> TileEntityType.Builder.create(TileMechanicalBrewery::new, BLOCK_MECHANICAL_BREWERY.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TILE_MECHANICAL_DAISY = TILES.register(LibNames.MECHANICAL_DAISY, () -> TileEntityType.Builder.create(TileMechanicalDaisy::new, BLOCK_MECHANICAL_DAISY.get()).build(null));

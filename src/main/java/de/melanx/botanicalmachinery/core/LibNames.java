...
public class LibNames {
    ...
    public static final String MECHANICAL_MANA_INFUSER = "mechanical_mana_infuser";
    public static final String MANA_INFUSER_OVERLAY = "mana_infuser_overlay";
    public static final String MANA_BATTERY = "mana_battery";
    public static final String MANA_BATTERY_CREATIVE = MANA_BATTERY + "_creative";
